import { setComparisonFromLS, setShouldShowEmptyComparison } from '@/context/comparison/index';
...
export const addComparisonItemToLs = (product: IProduct, withToast = true) => {
  ...
  const existingItem = comparisonFromLS.find((item) => item.productId === product._id);
