...
const FavoritesPage = () => {
  ...
  const { getDefaultTextGenerator, getTextGenerator } = useBreadcrumbs('favorites');
      ...
      {!shouldShowEmptyFavorites ? (
        <section className={styles.favorites}>
          <div className={`container ${styles.favorites__container}`}>
            <HeadeingWithCount
              count={currentFavoritesByAuth.length} // выводим просто длину массива со всеми товарами
            ...
            */}
            {(isUserAuth() ? favoriteSpinner || loginCheckSpinner : favoriteSpinner) && (
