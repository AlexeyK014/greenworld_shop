        ...
        <div className="container footer__top__container">
          ...
          <ul className="list-reset footer__socials">
            <li className="footer__socials__item">
              <a href="https://t.me/dvejer" className="footer__socials__item__link" />
            </li>
            <li className="footer__socials__item">
              <a href="https://vk.com" className="footer__socials__item__link" />
            </li>
            <li className="footer__socials__item">
      ...
      <div className="footer__bottom">
        <div className="container footer__bottom__container">
          <div className="footer__copyright">
            © 2026 ИП {translations[lang].footer.copyright}
            <br />
            (18+)
          </div>
          <div className="footer__policy">
            ...
            {isMedia640 && <FooterMobileLink text={translations[lang].footer.full_version} />}
          </div>
          {!isMedia640 && <FooterMobileLink text={translations[lang].footer.mobile_version} />}
        </div>
      </div>
    </footer>
  );
