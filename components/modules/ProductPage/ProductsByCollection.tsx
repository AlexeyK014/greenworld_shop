...
const ProductsByCollection = ({ collection }: { collection: string }) => {
  ...
  const currentCategory =
    alowedCollectionsCategories[Math.floor(Math.random() * alowedCollectionsCategories.length)];
  ...
  return (
    <div className={styles.product__collection}>
      <span className={styles.product__collection__bg}>{capitalizeCollection}</span>
