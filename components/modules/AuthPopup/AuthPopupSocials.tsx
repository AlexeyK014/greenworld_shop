...
import { faGithub, faGoogle, faVk, faYandex } from '@fortawesome/free-brands-svg-icons';
...
const AuthPopupSocials = ({
  ...
  <div className="cart-body__socials">
    ...
    <button className="btn-reset socials__btn y-color" onClick={handleSignupWithOAuth}>
      <FontAwesomeIcon icon={faYandex} bounce />
    </button>
    <button className="btn-reset socials__btn vk-color" onClick={handleSignupWithOAuth}>
