...
//   const favoritesItemBySize = currentFavoriteItems.find((item) => item.size
//     // === selectedSize
//   );
...
//       backgroundColor:
//         item.isSelected
//         // || selectedSize === item.manufacturerSize.toLowerCase()
//           ? '#3CB371'
//           : 'transparent',
...
//       </div>
//       <AddToCartBtn
//         handleAddToCart={isAddToFavorites ? handleAddProductToFavorites
//           : addToCart
//         }
//         addToCartSpinner={addToCartSpinner || updateCountSpinner || addToFavoritesSpinner}
//         btnDisabled={addToCartSpinner || updateCountSpinner}
